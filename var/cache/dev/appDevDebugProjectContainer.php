...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fgs_bootstrap.bootstrap_form_extension' => 'getFgsBootstrap_BootstrapFormExtensionService',
            'fgs_gestion_compte.type.categorie_mouvement_financier' => 'getFgsGestionCompte_Type_CategorieMouvementFinancierService',
            'fgs_gestion_compte.type.mouvement_financier' => 'getFgsGestionCompte_Type_MouvementFinancierService',
            'fgs_gestion_compte.type.mouvement_financier_planifie' => 'getFgsGestionCompte_Type_MouvementFinancierPlanifieService',
            ...
            'user.new_utilisateur' => 'getUser_NewUtilisateurService',
            'user.utilisateur_resetting' => 'getUser_UtilisateurResettingService',
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('iUQFO7P9qm', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('spS5o88Ilh', 0, 'Rza2GrW+COuM9LA4yt586Q', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('user.new_utilisateur', 'FGS\\UserBundle\\EventListener\\NewUtilisateurListener');
        $instance->addSubscriberService('user.utilisateur_resetting', 'FGS\\UserBundle\\EventListener\\UtilisateurResettingListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addResolveTargetEntity('FGS\\GestionComptesBundle\\Model\\UtilisateurInterface', 'FGS\\UserBundle\\Entity\\User', array());
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'banque', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => '5.5.42', 'defaultTableOptions' => array()), $b, $d, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\FGS\\GestionComptesBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\FGS\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'FGS\\GestionComptesBundle\\Entity');
        $c->addDriver($b, 'FGS\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('FGSGestionComptesBundle' => 'FGS\\GestionComptesBundle\\Entity', 'FGSUserBundle' => 'FGS\\UserBundle\\Entity'));
        ...
        $d->addCustomHydrationMode('array_key_value_hydrator', 'FGS\\GestionComptesBundle\\Hydrator\\ArrayKeyValueHydrator');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_9f3309e90fd4a09f3a09da4a5a43e2367657738c133375a624a44169736855c2');
    ...
    /**
     * Gets the public 'fgs_bootstrap.bootstrap_form_extension' shared service.
     *
     * @return \FGS\BootstrapBundle\Twig\BootstrapFormExtension
     */
    protected function getFgsBootstrap_BootstrapFormExtensionService()
    {
        return $this->services['fgs_bootstrap.bootstrap_form_extension'] = new \FGS\BootstrapBundle\Twig\BootstrapFormExtension();
    }

    /**
     * Gets the public 'fgs_gestion_compte.type.categorie_mouvement_financier' shared service.
     *
     * @return \FGS\GestionComptesBundle\Form\Type\CategorieMouvementFinancierType
     */
    protected function getFgsGestionCompte_Type_CategorieMouvementFinancierService()
    {
        return $this->services['fgs_gestion_compte.type.categorie_mouvement_financier'] = new \FGS\GestionComptesBundle\Form\Type\CategorieMouvementFinancierType($this->get('doctrine.orm.default_entity_manager'), $this->get('security.token_storage'));
    }

    /**
     * Gets the public 'fgs_gestion_compte.type.mouvement_financier' shared service.
     *
     * @return \FGS\GestionComptesBundle\Form\Type\MouvementFinancierType
     */
    protected function getFgsGestionCompte_Type_MouvementFinancierService()
    {
        return $this->services['fgs_gestion_compte.type.mouvement_financier'] = new \FGS\GestionComptesBundle\Form\Type\MouvementFinancierType($this->get('doctrine.orm.default_entity_manager'), $this->get('security.token_storage'));
    }

    /**
     * Gets the public 'fgs_gestion_compte.type.mouvement_financier_planifie' shared service.
     *
     * @return \FGS\GestionComptesBundle\Form\Type\MouvementFinancierPlanifieType
     */
    protected function getFgsGestionCompte_Type_MouvementFinancierPlanifieService()
    {
        return $this->services['fgs_gestion_compte.type.mouvement_financier_planifie'] = new \FGS\GestionComptesBundle\Form\Type\MouvementFinancierPlanifieType($this->get('doctrine.orm.default_entity_manager'), $this->get('security.token_storage'));
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('FGS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => '@FOSUser/Registration/email.txt.twig', 'resetting.template' => '@FOSUser/Resetting/email.txt.twig', 'from_email' => array('confirmation' => array('do-not-reply@ma-petite-tirelire.fr' => 'Do not reply'), 'resetting' => array('do-not-reply@ma-petite-tirelire.fr' => 'Do not reply'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('FGS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('FGS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('FGS\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager(${($_ = isset($this->services['fos_user.util.password_updater']) ? $this->services['fos_user.util.password_updater'] : $this->getFosUser_Util_PasswordUpdaterService()) && false ?: '_'}, ${($_ = isset($this->services['fos_user.util.canonical_fields_updater']) ? $this->services['fos_user.util.canonical_fields_updater'] : $this->getFosUser_Util_CanonicalFieldsUpdaterService()) && false ?: '_'}, $this->get('doctrine')->getManager(NULL), 'FGS\\UserBundle\\Entity\\User');
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\HttpFoundation\RequestMatcher('^/test-mail');
        ...
        $m->add($k, array(0 => 'ROLE_SUPER_ADMIN'), NULL);
        ...
        $p->setOptions(array('login_path' => 'fos_user_security_login', 'always_use_default_target_path' => true, 'default_target_path' => 'fgs_gestion_comptes_all', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    {
        return $this->services['session.storage.native'] = new \Symfony\Component\HttpFoundation\Session\Storage\NativeSessionStorage(array('name' => 'ma_petite_tirelire', 'cookie_httponly' => true, 'gc_probability' => 1), $this->get('session.handler'), ${($_ = isset($this->services['session.storage.metadata_bag']) ? $this->services['session.storage.metadata_bag'] : $this->getSession_Storage_MetadataBagService()) && false ?: '_'});
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($this->get('twig.loader'), array('form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'FGSBootstrapBundle:Form:fields.html.twig'), 'debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));

        $instance->addExtension($this->get('fgs_bootstrap.bootstrap_form_extension'));
    ...
    {
        return $this->services['twig.form.renderer'] = new \Symfony\Bridge\Twig\Form\TwigRenderer(new \Symfony\Bridge\Twig\Form\TwigRendererEngine(array(0 => 'form_div_layout.html.twig', 1 => 'FGSBootstrapBundle:Form:fields.html.twig'), $this->get('twig')), $this->get('security.csrf.token_manager', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\FGS\\UserBundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\FGS\\BootstrapBundle/Resources/views'), 'FGSBootstrap');
        $instance->addPath(($this->targetDirs[3].'\\src\\FGS\\GestionComptesBundle/Resources/views'), 'FGSGestionComptes');
        $instance->addPath(($this->targetDirs[3].'\\src\\FGS\\UserBundle/Resources/views'), 'FGSUser');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('!!_Th1sIsTheB3stAwsomeP@ssw0rdEv3r_!!');
    }

    /**
     * Gets the public 'user.new_utilisateur' shared service.
     *
     * @return \FGS\UserBundle\EventListener\NewUtilisateurListener
     */
    protected function getUser_NewUtilisateurService()
    {
        return $this->services['user.new_utilisateur'] = new \FGS\UserBundle\EventListener\NewUtilisateurListener($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the public 'user.utilisateur_resetting' shared service.
     *
     * @return \FGS\UserBundle\EventListener\UtilisateurResettingListener
     */
    protected function getUser_UtilisateurResettingService()
    {
        return $this->services['user.utilisateur_resetting'] = new \FGS\UserBundle\EventListener\UtilisateurResettingListener($this->get('router'));
    }
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rL0XKm-G-Y', 0, 'Rza2GrW+COuM9LA4yt586Q', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        ...
        $instance->setVoters(array(0 => new \Symfony\Component\Security\Core\Authorization\Voter\AuthenticatedVoter($a), 1 => new \Symfony\Component\Security\Core\Authorization\Voter\RoleHierarchyVoter($b), 2 => new \Symfony\Component\Security\Core\Authorization\Voter\ExpressionVoter(new \Symfony\Component\Security\Core\Authorization\ExpressionLanguage(), $a, $b), 3 => new \FGS\GestionComptesBundle\Security\Authorization\Voter\MouvementFinancierVoter(), 4 => new \FGS\GestionComptesBundle\Security\Authorization\Voter\CompteOrCategorieVoter()));
    ...
    {
        return $this->services['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(wdt|profiler))/'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/')));
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'FGSBootstrapBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\FGS\\BootstrapBundle'),
                    'namespace' => 'FGS\\BootstrapBundle',
                ),
                'FGSGestionComptesBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\FGS\\GestionComptesBundle'),
                    'namespace' => 'FGS\\GestionComptesBundle',
                ),
                'FGSUserBundle' => array(
                    'parent' => 'FOSUserBundle',
                    'path' => ($this->targetDirs[3].'\\src\\FGS\\UserBundle'),
            ...
            case 'images_directory': $value = ($this->targetDirs[3].'\\app/../web/img'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FGSBootstrapBundle' => 'FGS\\BootstrapBundle\\FGSBootstrapBundle',
                'FGSGestionComptesBundle' => 'FGS\\GestionComptesBundle\\FGSGestionComptesBundle',
                'FGSUserBundle' => 'FGS\\UserBundle\\FGSUserBundle',
            ...
            'session_name' => 'ma_petite_tirelire',
            'database_host' => '127.0.0.1',
            'database_port' => NULL,
            'database_driver' => 'pdo_mysql',
            'database_name' => 'banque',
            'database_user' => 'root',
            'database_password' => NULL,
            'database_charset' => 'UTF8',
            'database_server_version' => '5.5.42',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => '!!_Th1sIsTheB3stAwsomeP@ssw0rdEv3r_!!',
            'fos_user_bundle_from_adress' => 'do-not-reply@ma-petite-tirelire.fr',
            'fos_user_bundle_from_name' => 'Do not reply',
            'my_locale' => 'en',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '!!_Th1sIsTheB3stAwsomeP@ssw0rdEv3r_!!',
            ...
            'twig.form.resources' => array(
                ...
                1 => 'FGSBootstrapBundle:Form:fields.html.twig',
            ),
            ...
            'fos_user.model.user.class' => 'FGS\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'do-not-reply@ma-petite-tirelire.fr' => 'Do not reply',
            ),

...
class __TwigTemplate_059c9cb0912b695542bf1c3159be367a1fc1b71c9dd42c5b7db9bdfd69b47684 extends Twig_Template
{
...
{% block title %}Ajouter une Banque{% endblock %}
...
{% block contenu %}
    <h1 class=\"page-header\">{% block titre_contenu %}Ajouter une Banque{% endblock %}</h1>
    {{ form(form) }}
{% endblock %}

...
class __TwigTemplate_c8aabb74b7ff97009a4e0f961ec5cfafb0b3c3d93498f3c21af9de8d9b94cd1b extends Twig_Template
{
    ...
    public function block_contenu($context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["Banques"]) ? $context["Banques"] : $this->getContext($context, "Banques")));
        foreach ($context['_seq'] as $context["_key"] => $context["Banque"]) {
            // line 12
            echo "            <tr>
                <td > <img width=\"100\" height=\"100\" src=\"";
            // line 13
            echo twig_escape_filter($this->env, $this->env->getExtension('Symfony\Bridge\Twig\Extension\AssetExtension')->getAssetUrl(("img/" . $this->getAttribute($context["Banque"], "urlImage", array()))), "html", null, true);
            echo "\" >
                </td>
                <td>";
            // line 15
            echo twig_escape_filter($this->env, $this->getAttribute($context["Banque"], "Nom", array()), "html", null, true);
            echo "</td>
...
";
    ...
    {
        return array (  118 => 20,  107 => 15,  102 => 13,  99 => 12,  95 => 11,  87 => 5,  78 => 4,  60 => 3,  42 => 2,  11 => 1,);
    }
...
{% block contenu %}
    <table class=\"table\">
        ...
        {% for Banque in Banques %}
            <tr>
                <td > <img width=\"100\" height=\"100\" src=\"{{ asset('img/'~ Banque.urlImage)}}\" >
                </td>
                <td>{{ Banque.Nom }}</td>

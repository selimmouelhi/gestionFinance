...
class __TwigTemplate_8313a2d6058c237a26af73aea8ec74d7809f974adcb79ffe1ce2bdc419761347 extends Twig_Template
{
    ...
    public function block_panel_heading($context, array $blocks = array())
    {
        ...
        echo "</h2>Nouveau compte validé</h2>";
    ...
    \t\t<a href=\"";
        ...
        echo "\" class='ma-petite-tirelire'>Se rendre sur la page principale</a>
    \t</p>
    </p>
";
    ...
    {
        return array (  130 => 22,  126 => 21,  123 => 20,  120 => 19,  111 => 18,  97 => 13,  92 => 11,  89 => 10,  80 => 9,  62 => 7,  43 => 5,  11 => 1,);
    }
...
{% block title %}{{ parent() }} : Nouveau compte validée{% endblock %}

{% block panel_heading %}</h2>Nouveau compte validé</h2>{% endblock %}

{% block panel_body %}
\t<p class=\"text-justify\">
    \t{{ 'registration.confirmed'|trans({'%username%': user.username}) }}
    \t<p class='text-center' style='margin-top:50px;'>
    \t\t<a href=\"{{ path('fgs_gestion_comptes_homepage') }}\" class='ma-petite-tirelire'>Se rendre sur la page principale</a>
    \t</p>
    </p>
{% endblock %}
...
{% block panel_footer %}
    ...
    <p class=\"text-justify\">
    \t<a href=\"{{ targetUrl }}\">
    \t{{ 'registration.back'|trans }}</a>
    </p>
    {% endif %}
{% endblock %}
", "@FOSUser/Registration/confirmed.html.twig", "C:\\wamp64\\www\\GestionComptes-master\\src\\FGS\\UserBundle\\Resources\\views\\Registration\\confirmed.html.twig");
    }
}
